...
import { Settings, MapPin, Clock, FileText, Store, Edit3, X, Loader2, Lock, Save, AlertCircle } from "lucide-react";
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            {editing ? (
              ...
              <p className="text-sm text-slate-700 px-4 py-2.5 bg-slate-50 rounded-xl border border-slate-100 min-h-[72px] whitespace-pre-wrap">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {editing ? (
                ...
                <p className="text-sm text-slate-700 px-4 py-2.5 bg-slate-50 rounded-xl border border-slate-100 font-mono">
                  {data.latitude ?? <span className="text-slate-400 italic font-sans">—</span>}
                </p>
              )}
            </div>
            <div>
              ...
              {editing ? (
                ...
                <p className="text-sm text-slate-700 px-4 py-2.5 bg-slate-50 rounded-xl border border-slate-100 font-mono">
                  {data.longitude ?? <span className="text-slate-400 italic font-sans">—</span>}
                </p>
              )}
            </div>
          </div>
